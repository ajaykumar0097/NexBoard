...
const NotificationMsg = () => {
  ...
  return (
   <>
    <div className="d-flex justify-content-center align-items-center notification__panel p-2 mx-2 my-1">
        <div className="d-flex  user__img notification__content">
         <div className="position-relative">
          ...
          <div className="content__not">
            <h4 className="px-2">
              <span>
                <b>Ajay</b> added to his favorite list{" "}
                <b>Leather belt steve madden</b>
              </span>
            </h4>
            <p className="px-2">few seconds ago!</p>
          </div>
        </div>
